...
export default function Home() {
  ...
  const handleSignIn = () => {
    ...
    api({ sendToken: false, body: { username, password }, type: TypeHTTP.POST, path: role === roles.admin ? '/auth/sign-in-with-manager' : role === roles.student ? '/auth/sign-in-with-student' : '/auth/sign-in-with-teacher' })
      .then(res => {
