    ...
    return (
        <div style={visible ? { width: '1200px', padding: '15px', maxHeight: '570px', overflowY: 'auto' } : { width: 0, height: 0, padding: 0 }} className='overflow-y-hidden bg-[white] flex flex-col gap-2 z-50 fixed top-[50%] left-[50%] translate-x-[-50%] transition-all translate-y-[-50%] rounded-lg overflow-hidden'>
            ...
            <div className='flex justify-evenly mb-1'>
                <select onChange={e => setHocPhan({ ...hocPhan, monHoc: { maMon: e.target.value } })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                    <option value=''>Môn Học</option>
                    {dsMonHoc.map((monhoc, index) => (
                        <option value={monhoc.maMon} key={index}>{monhoc.tenMon}</option>
                    ))}
                </select>
                <select onChange={e => setHocPhan({ ...hocPhan, lop: { maLop: e.target.value } })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                    <option value=''>Lớp</option>
                    {dsLop.map((lop, index) => (
                        <option value={lop.maLop} key={index}>{lop.tenLop}</option>
                    ))}
                </select>
                <select onChange={e => setHocPhan({ ...hocPhan, hocKy: { maHocKy: e.target.value } })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
            ...
            <div className='flex justify-evenly mb-1'>
                ...
                <div className='w-[30%] text-[14px] gap-2 flex items-center justify-start'>
                    <input type='checkbox' onChange={e => setTienQuyet(e.target.value === 'on' ? true : false)} className='w-[15px] h-[15px]' />
                    <span>Môn Tiên Quyết</span>
                </div>
                <select onChange={e => setHocPhan({ ...hocPhan, loaiDangKy: e.target.value })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
            ...
            <div className='flex flex-col mb-1'>
                ...
                <div className='flex justify-evenly mb-1' s>
                    <select onChange={e => setTietLyThuyet({ ...tietLyThuyet, ngay: e.target.value })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                    ...
                    <select onChange={e => setTietLyThuyet({ ...tietLyThuyet, tiet: e.target.value })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                    ...
                    <input value={tietLyThuyet.phong} onChange={e => setTietLyThuyet({ ...tietLyThuyet, phong: e.target.value })} placeholder='Phòng' className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md' />
                </div>
            </div>
            <div className='flex justify-evenly mb-1'>
                <select onChange={e => setTietLyThuyet({ ...tietLyThuyet, giaoVien: { maGiaoVien: Number(e.target.value.split('-')[0]), tenGiaoVien: e.target.value.split('-')[1] } })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
            ...
            <div className='flex flex-col mb-1'>
                ...
                <div className='flex justify-evenly mb-1'>
                    <select onChange={e => setTietThucHanhNhom1({ ...tietThucHanhNhom1, ngay: e.target.value })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                        <option value={null}>Chọn Ngày Trong Tuần</option>
                        <option value={2}>Thứ Hai</option>
                        <option value={3}>Thứ Ba</option>
                        <option value={4}>Thứ Tư</option>
                        <option value={5}>Thứ Năm</option>
                    ...
                    <select onChange={e => setTietThucHanhNhom1({ ...tietThucHanhNhom1, tiet: e.target.value })} className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md'>
                        <option value={null}>Chọn Thời Gian</option>
                        <option value={'1-2'}>{'Tiết 1-2 (6h30 - 8h10)'}</option>
                        <option value={'1-3'}>{'Tiết 1-3 (6h30 - 9h)'}</option>
                        <option value={'2-3'}>{'Tiết 2-3 (7h20 - 9h)'}</option>
                        <option value={'3-4'}>{'Tiết 3-4 (8h10 - 10h)'}</option>
                    ...
                    <input value={tietThucHanhNhom1.phong} onChange={e => setTietThucHanhNhom1({ ...tietThucHanhNhom1, phong: e.target.value })} placeholder='Phòng' className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md' />
                </div>
            </div>
            <div className='flex justify-evenly mb-1'>
            ...
            {tietThucHanhNhom2 && <>
                <div className='flex flex-col mb-1'>
                    ...
                    <div className='flex justify-evenly mb-1'>
                        ...
                        <input value={tietThucHanhNhom2.phong} onChange={e => setTietThucHanhNhom2({ ...tietThucHanhNhom2, phong: e.target.value })} placeholder='Phòng' className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md' />
                    </div>
                </div>
                <div className='flex justify-evenly mb-1'>
            ...
            {tietThucHanhNhom3 && <>
                <div className='flex flex-col mb-1'>
                    ...
                    <div className='flex justify-evenly mb-1'>
                        ...
                        <input value={tietThucHanhNhom3.phong} onChange={e => setTietThucHanhNhom3({ ...tietThucHanhNhom3, phong: e.target.value })} placeholder='Phòng' className='w-[30%] text-[14px] focus:outline-0 px-[10px] h-[35px] border-[#c1c1c1] border-[1px] rounded-md' />
                    </div>
                </div>
                <div className='flex justify-evenly mb-1'>
